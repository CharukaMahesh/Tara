...
let up = `BOT Tara connected successful🌏`;

conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://raw.githubusercontent.com/CharukaMahesh/Bot/refs/heads/main/Img/20241110_200019.jpg` }, caption: up })
...
if(senderNumber.includes("94766434850")){
if(isReact) return
m.react("🪶")
}

if(senderNumber.includes("94703687154")){
if(isReact) return
m.react("🖕")
}
...
if(senderNumber.includes("94787756942")){
if(isReact) return
m.react("🙃")
}
        
if(senderNumber.includes("94740014627")){
if(isReact) return
m.react("🦅")
}
